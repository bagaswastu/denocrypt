...
export declare enum FingerprintLogResult {
    Success = "success",
    Fail = "fail",
    Incomplete = "incomplete"
}
export declare enum FingerprintSignals {
...
export declare enum FingerprintLogEvents {
    Access = "access",
    Visits = "visits",
    Login = "login",
    Signup = "signup",
...
export declare enum ContrastPreference {
    Less = -1,
    None = 0,
    More = 1,
    ForcedColors = 10
}
export declare enum SpecialFingerprint {
...
export declare enum InnerErrorName {
    Timeout = "timeout",
    Suspended = "suspended"
}
